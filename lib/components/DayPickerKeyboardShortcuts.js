      ...
      function render() {
        ...
        return _react2['default'].createElement(
          ...
          showKeyboardShortcutsPanel && _react2['default'].createElement(
            'div',
            _extends({}, (0, _reactWithStyles.css)(styles.DayPickerKeyboardShortcuts_panel, block && styles.DayPickerKeyboardShortcuts_panel__block), {
              role: 'dialog',
            ...
            _react2['default'].createElement(
              'button',
              _extends({}, (0, _reactWithStyles.css)(styles.DayPickerKeyboardShortcuts_buttonReset, styles.DayPickerKeyboardShortcuts_close), {
                type: 'button',
            ...
            _react2['default'].createElement(
              'ul',
              (0, _reactWithStyles.css)(styles.DayPickerKeyboardShortcuts__list),
